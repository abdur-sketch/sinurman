...
const tables=["users","students","tahfidz_records","mutabaah_records","health_records","transactions","character_reports","inventory_items","announcements","notification_logs","attendance_records","leave_permits","schedules","rooms","admissions","counseling_records","bills","guardian_messages","audit_logs"];
