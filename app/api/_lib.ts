  ...
  schemaReady = (async () => {
    ...
    const upgrades: Record<string, Record<string, string>> = {
      ...
      admissions: {
        ...
        wave: "TEXT NOT NULL DEFAULT 'Gelombang 1'",
