...
export default function PublicPpdbPage() {
  ...
  return <main className="public-ppdb">
    <header className="ppdb-public-header"><a className="ppdb-public-brand" href="/ppdb"><span>ن</span><div><strong>SINURMAN</strong><small>PPDB Pondok Pesantren Nurul Iman</small></div></a><a className="secondary-button link-button" href="/signin-with-chatgpt?return_to=%2F">Masuk Portal Internal</a></header>
